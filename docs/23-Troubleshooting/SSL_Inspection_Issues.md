...
Follow [Configure HTTPS Inspection](../05-SSL_Inspection/01-Configure_HTTPS_Inspection.md) and [Import certificate into Firefox](../26-Server_Verification/main.md) or Chrome/IE.
