...
Then test your HTTPS Inspection enabled or not. If if not enabled see our document - [How to configure HTTPS inspection](/docs/SSL%20Inspection/main)

Then check the SSL certificate in the browser. See [Test certificate in Firefox](/docs/SSL%20Inspection/main).
