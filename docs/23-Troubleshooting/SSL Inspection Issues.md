...
Follow [Import certificate into Firefox](/docs/SSL%20Inspection/main).

Follow the [Import your SSL certificate into Internet Explorer or Chrome browser.](/docs/Server%20Verification/main)
...
- **Interface Checks**: Confirm the SafeSquid Root CA is installed in the browser trust store ([Server Verification](/docs/Server%20Verification/main)). In Configuration Portal, HTTPS Inspection policies match the intended bypass/enforce rules; SSL Certs/Cache cleared if DNS mismatch was the issue.
...
**Related**: [SSL Inspection](/docs/SSL%20Inspection/main), [Server Verification](/docs/Server%20Verification/main), [Troubleshooting](/docs/Troubleshooting/main)
