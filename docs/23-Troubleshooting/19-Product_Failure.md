...
:::note
Restart SafeSquid service from the SafeSquid Interface will work, only if the [monit service](/02-SafeSquid_SWG/07-Supporting_Services/01-Monit) is configured properly on the SafeSquid server.
:::
