...
:::note
Restart SafeSquid service from the SafeSquid Interface will work, only if the [monit service](/docs/SafeSquid%20SWG/Supporting%20Services/Monit) is configured properly on the SafeSquid server.
:::
