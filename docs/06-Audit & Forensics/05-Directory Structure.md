...
SafeSquid stores **tcp\_tune.sh** script in the directory **/etc/init.d/** for TCP Tunning. This script will optimise/set some of the values of the TCP parameters like
...
- [**config\_XXXX@YYYY\_ZZZZ.xml**](mailto\:config_XXXX@YYYY_ZZZZ.xml): A backup file representing the last saved configuration, where:
