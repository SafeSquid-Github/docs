...
SafeSquid integrates with VPN infrastructure so policy enforcement extends to remote users and branch offices. For identity and authentication integration (Active Directory, OpenLDAP, SSO), see [Authentication](/04-Authentication/main) and [Directory Services](/04-Authentication/03-Directory_Services/main).



## Integration guides

### [VPN Integration](/20-Integrations/02-VPN/main)
...
Combine with [Authentication](/04-Authentication/main) and [Access Restriction](/08-Access_Restriction/main) for identity-based policy over VPN traffic.
