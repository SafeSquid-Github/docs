...
SafeSquid integrates with VPN infrastructure so policy enforcement extends to remote users and branch offices. For identity and authentication integration (Active Directory, OpenLDAP, SSO), see [Authentication](/docs/Authentication/) and [Directory Services](/docs/Authentication/Directory_Services/main/).



## Integration guides

### [VPN Integration](/docs/Integrations/VPN/)
...
Combine with [Authentication](/docs/Authentication/) and [Access Restriction](/docs/Access_Restriction/) for identity-based policy over VPN traffic.
