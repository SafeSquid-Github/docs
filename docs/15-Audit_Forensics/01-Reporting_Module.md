...
![Edit report based on number of transactions by default.](/images/How_To/Reporting_Dashboard/image4.webp)

![Apply filter to view safesquid report](/images/How_To/Reporting_Dashboard/image5.webp)

![Choose no of filtering option to view safesquid report](/images/How_To/Reporting_Dashboard/image6.webp)

![Close filter menu safesquid report](/images/How_To/Reporting_Dashboard/image7.webp)
...
![Flush button to reset filters of safesquid report](/images/How_To/Reporting_Dashboard/image10.webp)
...
**Related**: [Security Logs](/15-Audit_Forensics/02-Security_Logs), [Performance Plot](/15-Audit_Forensics/03-Performance_Plot)
