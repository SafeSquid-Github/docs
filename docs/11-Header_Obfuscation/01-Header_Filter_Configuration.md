...
- **Interface Checks**: In [Configuration Portal](/02-SafeSquid_SWG/01-Configuration_Portal), Restriction Profiles → Header Filter: Global enabled, Allow/Deny/Insert rules match intent; Type, Value, and Applies to are set correctly.
...
**Related**: [Cookie Inspection](/12-Cookie_Inspection/main), [Access Restriction](/08-Access_Restriction/main), [URL Redirection SafeSearch](/10-URL_Redirection/02-SafeSearch), [Troubleshooting](/23-Troubleshooting/main)
