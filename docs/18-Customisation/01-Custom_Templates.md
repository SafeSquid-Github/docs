...
![Editing the comment as per your entry](/images/How_To/Create_Custom_Templates/image7.webp)

![In profiles, selecting the required profile in the drop down menu](/images/How_To/Create_Custom_Templates/image8.webp)

![Do not change the "name" field](/images/How_To/Create_Custom_Templates/image9.webp)

![Giving the name of your html file in file field](/images/How_To/Create_Custom_Templates/image10.webp)

![clicking on save policy to save it](/images/How_To/Create_Custom_Templates/image11.webp)
...
- **Interface Checks**: In [Configuration Portal](/02-SafeSquid_SWG/01-Configuration_Portal), Custom Settings → Custom Templates: new template appears in the list with correct content and is assigned to the intended policy or block page.
...
**Related**: [Startup Parameters](/18-Customisation/02-Startup_Parameters), [Customisation](/18-Customisation/main), [Access Restriction](/08-Access_Restriction/main), [Troubleshooting](/23-Troubleshooting/main)
