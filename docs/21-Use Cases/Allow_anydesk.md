...
- **Interface Checks**: In [Configuration Portal](/docs/SafeSquid%20SWG/Configuration%20Portal), confirm Real-time content security → HTTPS Inspection has Bypass SSL Inspection policy enabled, and Restriction Policies → Access profiles show the allow policy for the remote desktop application with the correct request type and Bypass SSL Inspection profile.
...
**Related**: [SSL Inspection](/docs/SSL%20Inspection/main), [Access Restriction](/docs/Access%20Restriction/main), [Application Signatures](/docs/Profiling%20Engine/Application%20Signatures), [Restrict AnyDesk](Restrict_any_desk.md), [Troubleshooting](/docs/Troubleshooting/main)
