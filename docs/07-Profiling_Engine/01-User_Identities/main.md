...
### [IP-Based Recognition](/04-Authentication/02-Network_Signature)
...
### [OpenLDAP Integration](/04-Authentication/03-Directory_Services/02-OpenLDAP/main)
...
### [Active Directory Integration](/04-Authentication/03-Directory_Services/01-Active_Directory/main)
...
- [Credential-Based Authentication](/04-Authentication/01-BASIC) User accounts and encrypted credentials are stored locally. SafeSquid presents a login prompt, validates inputs internally, and applies identity-based policies. Entirely self-contained.
...
### [User Groups](/07-Profiling_Engine/01-User_Identities/01-User_Groups)
