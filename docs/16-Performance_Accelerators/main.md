...
### [Caching](/16-Performance_Accelerators/01-Caching)
...
### [Pre Fetching](/16-Performance_Accelerators/02-Pre_Fetching)
...
### [Manage Bandwidth](/16-Performance_Accelerators/03-Manage_Bandwidth)
...
### [Speed Limits](/16-Performance_Accelerators/04-Speed_Limits)
...
### [WCCP](/16-Performance_Accelerators/05-WCCP)
...
For high availability see [Proxy Clustering](/17-Proxy_Clustering/main); for operational modes see [Transparent Proxy](/19-Operational_Modes/02-Transparent_Proxy) and [WCCP](/16-Performance_Accelerators/05-WCCP).
