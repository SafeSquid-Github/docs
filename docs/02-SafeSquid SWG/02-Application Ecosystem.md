...
![SafeSquid Application Ecosystem overview or dashboard](/img/Application_Eco-System/Application_Eco-System/image1.webp)
...
- **Management plane**\
  Licenses, activation keys, and certificate lifecycles scatter across tools and tickets, slowing operators and creating outages. The Self-Service Portal centralizes these jobs: activate or renew licenses, manage the enterprise root CA and OCSP/CRL settings, enroll connectors, and adjust organization settings. Role-scoped access and activity history keep routine administration fast and accountable.
...
1. [Monit](/docs/SafeSquid%20SWG/Supporting%20Services/Monit) \
...
2. [BIND](/docs/SafeSquid%20SWG/Supporting%20Services/Bind)\
   Speeds up the DNS resolutions by utilizing Root DNS servers

3. [NTP](/docs/SafeSquid%20SWG/Supporting%20Services/NTP) \
