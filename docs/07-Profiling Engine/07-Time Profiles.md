...
Time Profiler enables time-based internet access policies using configurable time ranges: Month, Day, Weekday, Hour, and Minute.

Create entries to define Time Profiles as combinations of time ranges. Time Profiler allows or blocks categories and websites based on these ranges.
