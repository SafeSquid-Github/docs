...
## Prerequisites
HTTPS Inspection must be enabled in SafeSquid. See [How to enable HTTPS Inspection](/docs/SSL%20Inspection/main) if not yet enabled.
...
Read more about [How to block inappropriate images by using Image Analyzer](/docs/Profiling%20Engine/Content%20Analyser/Image%20Analyser%20AI)
...
Read more about [Image Analyzer](/docs/Profiling%20Engine/Content%20Analyser/Image%20Analyser%20AI) and [Text Analyzer](/docs/Profiling%20Engine/Content%20Analyser/Text%20Analyser)
...
## Included Modules
- [Image Analyzer](/docs/Profiling%20Engine/Content%20Analyser/Image%20Analyser%20AI): Detects inappropriate or non-compliant visual content using AI-powered image analysis
- [Text Analyzer](/docs/Profiling%20Engine/Content%20Analyser/Text%20Analyser): Scans and classifies textual content for profanity, hate speech, and policy violations
