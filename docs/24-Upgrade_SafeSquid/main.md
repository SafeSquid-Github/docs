...
### [OS Upgrade](/24-Upgrade_SafeSquid/02-OS_Upgrade/main)
...
### [Version Upgrade](/24-Upgrade_SafeSquid/01-Version_Upgrade/main)
...
After upgrade, verify with [Verify Your Setup](/01-Getting_Started/06-Verify_Your_Setup) and [Troubleshooting](/23-Troubleshooting/main) if issues appear.
