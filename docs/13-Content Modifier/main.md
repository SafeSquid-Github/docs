...
## Content modifier removes or changes content in real time

Use the Content Modifier to remove or modify content such as ActiveX, JavaScript, and cookies from selected websites. The modifier changes web pages, files, client headers, and server headers in real time.
