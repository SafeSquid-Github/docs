...
See the working of each Entry [here](/docs/Use%20Cases/working-of-default-entries-in-access-restrictions)
...
To authenticate all users from Active Directory, leave this field empty.
:::note
