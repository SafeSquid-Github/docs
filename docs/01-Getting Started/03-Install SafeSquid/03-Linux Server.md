...
:::info
This method installs the SafeSquid binary only. You are responsible for OS hardening, disk partitioning, and supporting services. For a fully automated setup, use the [Appliance Builder](/docs/Getting%20Started/Install%20SafeSquid/SafeSquid%20Appliance%20Builder) instead.
:::

## Prerequisites

- Linux server meeting [minimum requirements](/docs/Getting%20Started/Install%20SafeSquid/main) (4 CPU, 8 GB RAM, 100 GB disk)
- Root or sudo access
...
- **[Monit](/docs/SafeSquid%20SWG/Supporting%20Services/Monit)** — process monitoring and auto-restart for SafeSquid
- **[BIND9](/docs/SafeSquid%20SWG/Supporting%20Services/Bind)** — local DNS resolver used by SafeSquid
...
2. **[Connect a browser](/docs/Getting%20Started/Connect%20Your%20Client/main)** to verify traffic flows
3. **[Enable SSL Inspection](/docs/SSL%20Inspection/main)** for HTTPS visibility
