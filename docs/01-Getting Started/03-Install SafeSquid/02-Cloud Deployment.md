...
Attach the [SAB ISO](https://downloads.safesquid.com/appliance/safesquid.iso) to a cloud VM and follow the [Appliance Builder installation steps](/docs/Getting%20Started/Install%20SafeSquid/SafeSquid%20Appliance%20Builder).

### Option 4: TAR Package on Existing Cloud VM

If you already have a Linux VM running, install SafeSquid using the [TAR package method](/docs/Getting%20Started/Install%20SafeSquid/Linux%20Server).
