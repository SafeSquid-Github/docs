...
1. **Configure your browser** to use SafeSquid as the HTTP proxy (SafeSquid IP, port 8080). See [Connect Your Client](/docs/Getting%20Started/Connect%20Your%20Client/main) if you haven't done this yet.

2. **Open the SafeSquid interface** by navigating to [http://safesquid.cfg/](http://safesquid.cfg/) in your browser.

   When accessing for the first time, the interface prompts you to upload your activation key.

   ![Upload activation key prompt](/img/License_Activation/image13.webp)
   *Initial activation prompt in the SafeSquid interface*

3. **Select your activation key file** and click **Upload**.
