...
:::note
Restart SafeSquid service from the SafeSquid Interface will work, only if the [monit service](/docs/02-SafeSquid%20SWG/09-Supporting%20Services/01-Monit.md) is configured properly on the SafeSquid server.
:::
