...
| "SSL certificate verify failed" | SSL inspection enabled, CA not trusted | Install SafeSquid root CA (see [SSL Inspection](/05-SSL_Inspection/main)) |
...
2. **[SSL Inspection](/05-SSL_Inspection/main)** — Install root CA for apps that validate certificates (Git, pip, npm, Docker)
3. **[Access Restriction](/08-Access_Restriction/main)** — Set policies for specific applications or protocols
