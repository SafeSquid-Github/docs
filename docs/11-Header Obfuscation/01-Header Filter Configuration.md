...
- **Interface Checks**: In [Configuration Portal](/docs/SafeSquid%20SWG/Configuration%20Portal), Restriction Profiles → Header Filter: Global enabled, Allow/Deny/Insert rules match intent; Type, Value, and Applies to are set correctly.
...
**Related**: [Cookie Inspection](/docs/Cookie%20Inspection/main), [Access Restriction](/docs/Access%20Restriction/main), [URL Redirection SafeSearch](/docs/URL%20Redirection/SafeSearch), [Troubleshooting](/docs/Troubleshooting/main)
