...
### [Forward Proxy](/19-Operational_Modes/01-Forward_Proxy)
...
### [Transparent Proxy](/19-Operational_Modes/02-Transparent_Proxy)
...
### [TCP Proxy](/19-Operational_Modes/03-TCP_Proxy)
...
### [Reverse Proxy](/19-Operational_Modes/04-Reverse_Proxy)
...
### [Proxy Chain](/19-Operational_Modes/05-Proxy_Chain)
...
For client configuration see [Connect Your Client](/01-Getting_Started/05-Connect_Your_Client/main); for transparent redirection see [WCCP](/16-Performance_Accelerators/05-WCCP).
