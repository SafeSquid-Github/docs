...
### [Reporting module](/15-Audit_Forensics/01-Reporting_Module)
...
### [Security logs](/15-Audit_Forensics/02-Security_Logs)
...
### [Performance plot](/15-Audit_Forensics/03-Performance_Plot)
...
### [Monit](/15-Audit_Forensics/04-Monit)
...
### [Directory structure](/15-Audit_Forensics/05-Directory_Structure)
...
Correlate with [Security Logs](/15-Audit_Forensics/02-Security_Logs) and [Troubleshooting](/23-Troubleshooting/main) for incident response; for policy configuration see [Access Restriction](/08-Access_Restriction/main) and [Configuration Portal](/02-SafeSquid_SWG/01-Configuration_Portal).
