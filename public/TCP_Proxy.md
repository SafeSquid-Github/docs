...
- [Forward Proxy](/19-Operational_Modes/01-Forward_Proxy) for HTTP/HTTPS explicit proxy.
- [Transparent Proxy](/19-Operational_Modes/02-Transparent_Proxy) for interception without client config.
- [Proxy Chain](/19-Operational_Modes/05-Proxy_Chain) for forwarding to a parent proxy.
