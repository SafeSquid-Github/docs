...
| AD clock skew tolerance | **Draft** | **5 minutes** called out in the [Supporting Services hub](/getting-started/introduction/interface/supporting-services); **CTO** confirm max skew for supported builds |
...
**Related:** [Supporting Services Overview](/getting-started/introduction/interface/supporting-services)
