...
Complete prerequisites and installation steps below, then proceed to [Activate Your License](/Activate) and Verify your setup.
...
**Trade-off:** You must manually configure Monit, BIND9, and other dependencies. For automated setup, use [Appliance Builder](/SafeSquid_Appliance_Builder) instead.
...
- Linux server meeting [hardware requirements](/Deployment_Planning#hardware-sizing) (minimum 4 CPU cores, 8 GB RAM, 100 GB disk)
- Root or sudo access
...
**Full guide:** [Monit Configuration](/Supporting_Services_Monit)
...
**Full guide:** [BIND9 Configuration](/Bind)
...
2. **[Activate Your License](/Activate)** — Upload your activation key to make SafeSquid fully operational
3. **[Connect Your Client](/Connect_Your_Client)** — Configure a browser to use the proxy
4. **Verify your setup** — Confirm traffic flows through SafeSquid
5. **[Enable SSL Inspection](/SSL_Inspection)** — Decrypt and inspect HTTPS traffic
