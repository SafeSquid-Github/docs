...
- **RAM:** 8 GB minimum
- See [Deployment Planning](/Deployment_Planning) for full sizing guidance
...
- Download your activation key from the [Self-Service Portal](/Register) (you'll upload it after installation)
...
2. **[Connect Your Client](/Connect_Your_Client)** — Configure a browser to use the proxy
