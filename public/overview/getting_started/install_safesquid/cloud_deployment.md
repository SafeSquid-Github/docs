...
Select one cloud deployment method below, validate service health, then continue to [Activate Your License](/Activate).
...
Match your cloud instance to the [hardware sizing matrix](/Deployment_Planning#hardware-sizing):
...
- Use the [TAR package method](/Linux_Server) if you already have a Linux VM

**For platforms without cloud-init:**
- Attach the [SAB ISO](/SafeSquid_Appliance_Builder) to a cloud VM and follow the standard installation
...
Use [Configuration Sync](/Configuration_Sync) to replicate policies across instances in the auto-scaling group.
...
1. **[Activate Your License](/Activate)** — Upload your activation key to make SafeSquid fully operational
2. **[Connect Your Client](/Connect_Your_Client)** — Configure a browser to use the cloud proxy
3. **Verify your setup** — Confirm traffic flows through SafeSquid
4. **[Enable SSL Inspection](/SSL_Inspection)** — Decrypt and inspect HTTPS traffic
5. **[Set up HA](/Proxy_Clustering)** — Configure load balancing and failover for production
