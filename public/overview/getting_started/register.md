...
Operators cannot activate instances or unlock commercial capabilities without a key tied to the [Self-Service Portal](https://key.safesquid.com). Skipping registration blocks [Activate Your License](/Activate).
...
Complete **Registration Process** below, then [Install SafeSquid](/Install_SafeSquid) and [Activate Your License](/Activate).
...
1. [Install SafeSquid](/Install_SafeSquid) on your server or VM.
2. After installation, [Activate Your License](/Activate) by uploading this key in the SafeSquid interface.
