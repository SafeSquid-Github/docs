...
Try [System-Wide Proxy](/System_Wide_Proxy) first. Only configure apps individually if they ignore system settings.
...
| "SSL certificate verify failed" | SSL inspection enabled, CA not trusted | Install SafeSquid root CA (see [SSL Inspection](/SSL_Inspection)) |
...
2. **[SSL Inspection](/SSL_Inspection)** — Install root CA for apps that validate certificates (Git, pip, npm, Docker)
3. **[Access Restriction](/Access_Restriction)** — Set policies for specific applications or protocols
