...
1. **Verify your setup** — Sample endpoints to confirm proxy is working
2. **[SSL Inspection](/SSL_Inspection)** — Deploy root CA via GPO/MDM for HTTPS inspection
3. **[Configure Policies](/Access_Restriction)** — Now that all traffic flows through SafeSquid, set up access controls
