...
- License activated (see [Activate Your License](/Activate)) for full feature access
- Note your SafeSquid server IP address and port (default: 8080)
- For HTTPS sites, you'll need [SSL Inspection](/SSL_Inspection) configured later
...
### [System-Wide Proxy](/System_Wide_Proxy)
...
### [Enterprise Deployment](/Enterprise_Deployment)
...
### [Application-Specific Configuration](/Application_Specific_Configuration)
...
**For HTTPS sites:** You'll see certificate warnings until [SSL Inspection](/SSL_Inspection) is configured.

## Next Steps

1. **Verify your setup** — Run comprehensive smoke tests to confirm traffic flows
2. **[SSL Inspection](/SSL_Inspection)** — Enable HTTPS decryption so SafeSquid can inspect encrypted traffic
3. **[Configure Policies](/Access_Restriction)** — Set up access controls and content filtering
