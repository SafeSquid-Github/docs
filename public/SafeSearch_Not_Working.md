...
Then test your HTTPS Inspection enabled or not. If if not enabled see our document - [How to configure HTTPS inspection](/05-SSL_Inspection/main)

Then check the SSL certificate in the browser. See [Test certificate in Firefox](/05-SSL_Inspection/01-Configure_HTTPS_Inspection#import-certificate-into-firefox).
