...
### [Access Mobile Applications Through SafeSquid](/21-Use_Cases/01-Access_Mobile_Applications_Through_SafeSquid)
...
### [Access Remote Desktop Applications Through SafeSquid](/21-Use_Cases/02-Access_Remote_Desktop_Applications_Through_SafeSquid)
...
### [Access Business Applications Through SafeSquid](/21-Use_Cases/03-Accessing_business_applications_through_SafeSquid)
...
### [Allow AnyDesk](/21-Use_Cases/04-Allow_anydesk)
...
### [Allow Outlook To Work Through SafeSquid](/21-Use_Cases/05-Allow_Outlook_To_Work_through_SafeSquid)
...
### [Allow Remote Applications to Particular Users](/21-Use_Cases/06-Allow_remote_applications_to_particular_users)
...
### [Allow Social Networking Sites During Lunch Hours](/21-Use_Cases/07-Allow_Social_Networking_Sites_during_Lunch_Hours)
...
### [Allow Specific YouTube Channel and Its Playlist](/21-Use_Cases/08-Allow_Specific_YouTube_Channel_and_its_Playlist)
...
### [Allow Specific Page on Facebook](/21-Use_Cases/09-Allowing_Specific_Page_on_Facebook)
...
### [Block Advertisements and Banners](/21-Use_Cases/10-Block_Advertisements_And_Banners)
...
### [Block Emails or Files, Including Archives or Social Posts Using Keywords](/21-Use_Cases/11-Block_Emails_or_Files_including_archives_or_Social_Posts_using_Keywords)
...
### [Block Inappropriate Images Using Image Analyzer](/21-Use_Cases/12-Block_inappropriate_images_by_using_Image_Analyzer)
...
### [Block Particular User Login to Facebook or Gmail](/21-Use_Cases/13-Block_Particular_User_Login_To_Facebook_Or_Gmail)
...
### [Block Personal Gmail, Allow Google Corporate Accounts](/21-Use_Cases/14-Block_Personal_Gmail_Allow_Google_Corporate_Accounts)
...
### [Facebook Read-Only Mode](/21-Use_Cases/15-Facebook_Read_Only_Mode)
...
### [Block Specific YouTube Channel](/21-Use_Cases/16-Block_Specific_Youtube_Channel)
...
### [Restrict AnyDesk](/21-Use_Cases/17-Restrict_anydesk)
...
### [YouTube API Integration With SafeSquid To Allow Specific YouTube Videos](/21-Use_Cases/18-YouTube_API_Integration_With_SafeSquid_To_Allow_Specific_YouTube_Videos)
...
### [Native Sandboxing](/21-Use_Cases/19-Native_Sandboxing)
...
### [Elevated Privacy](/21-Use_Cases/20-Elevated_Privacy)
...
### [Working of Default Entries in Access Restrictions](/21-Use_Cases/21-working_of_default_entries_in_access_restrictions)
...
Configure [Access Restriction](/08-Access_Restriction/main) and [Profiling Engine](/07-Profiling_Engine/main) for policy; see [Troubleshooting](/23-Troubleshooting/main) if a use case does not behave as expected.
