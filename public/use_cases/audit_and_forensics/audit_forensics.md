...
Lack of visibility into web traffic and security events undermines incident response, compliance evidence, and audit. SafeSquid audit and forensics must answer practical questions: what happened, which user or administrator was involved, which policy fired, whether traffic was bypassed, and what evidence remains after the event.

SafeSquid provides that visibility through reporting, detailed request logs, configuration logs, bypass and privacy logs, performance monitoring, and operational records such as UI and privileged-access logs.



## Problem statement

Security controls fail operationally when the team cannot reconstruct events. Anonymous traffic, undocumented policy changes, missing bypass records, and poor retention all create false assurance.

## Client scenario

Use this hub when you need to design or investigate:

- compliance evidence for web-security controls
- incident timelines for user activity or threat events
- privileged changes and policy modifications
- cluster-wide visibility and retention strategy
...
### [Architecture and file layout](/getting-started/introduction/architecture)
