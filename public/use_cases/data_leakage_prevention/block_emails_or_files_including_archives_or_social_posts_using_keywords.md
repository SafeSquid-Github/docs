...
## [Manage Keyword Signatures using Self Service portal](/getting-started/introduction/architecture)
...
HTTPS Inspection must be enabled in SafeSquid. If not, see [How to enable HTTPS Inspection](/SSL_Inspection).
