...
### 1. [User Identities](/User_Identities) — Connect LDAP/AD, Create Groups
...
→ [Configure User Identities](/User_Identities)

---

### 2. [Web Categorization](/Web_Categorization) — Assign Sites to Categories
...
→ [Configure Web Categorization](/Web_Categorization)

---

### 3. [Architecture](/getting-started/introduction/architecture) — Detect Apps by Traffic Fingerprints
...
→ [Review the architecture guides](/getting-started/introduction/architecture)

---

### 4. [Content Analyser](/Content_Analyser) — Inspect Files, Text, Images
...
→ [Configure Content Analyser](/Content_Analyser)

---

### 5. [Request Profiles](/Request_Profiles) — Control by HTTP Method, Protocol, User-Agent
...
→ [Configure Request Profiles](/Request_Profiles)

---

### 6. [Response Profiles](/Response_Profiles) — Filter by MIME Type, File Size
...
→ [Configure Response Profiles](/Response_Profiles)

---

### 7. [Time Profiles](/Time_Profiles) — Enforce Policies by Time Window
...
→ [Configure Time Profiles](/Time_Profiles)
...
**Solution:** Use LDAP or SAML authentication. Configure [User Identities](/User_Identities) before building IP-based rules.
...
**Solution:** Enable [SSL Inspection](/SSL_Inspection) before relying on Content Analyser for DLP or malware detection.
...
**Prerequisites:**
- [Authentication Setup](/Authentication) — User identities require LDAP, AD, or SAML authentication

**Next Steps:**
- [Access Restrictions](/Access_Restriction) — Use profiles to build allow/block policies
- [Data Leakage Prevention](/Data_Leakage_Prevention) — Combine Content Analyser with DLP templates

**Troubleshooting:**
- [User Not Identified](/Troubleshooting) — LDAP bind failures, group membership issues
- [Application Not Detected](/Troubleshooting) — Signature tuning, false positives
