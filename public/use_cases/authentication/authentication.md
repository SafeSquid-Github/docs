...
**Comparative authentication feature matrix vs other SWG products:** **Not SSOT-backed in this doc set**—see [What is SafeSquid SWG?](/What_is_SafeSquid_SWG#architecture-and-positioning-claims-draft-vs-confirmed).
...
| [Architecture](/getting-started/introduction/architecture) | IP-based policy needed (devices, legacy apps) | Transparent (no login) | Static IP addressing or DHCP reservations |
...
### [IP-based recognition in architecture](/getting-started/introduction/architecture)
