...
**Product-level comparative claims** (for example vs other SWG vendors): **Not SSOT-backed in this doc set**—see [What is SafeSquid SWG?](/What_is_SafeSquid_SWG#architecture-and-positioning-claims-draft-vs-confirmed).
