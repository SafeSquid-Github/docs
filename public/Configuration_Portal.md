...
**First-time setup:** See [Connect Your Client](/01-Getting_Started/05-Connect_Your_Client/main) to configure your browser to use SafeSquid.
...
**Details:** [Access Restriction](/08-Access_Restriction/main)
...
**Details:** [Data Leakage Prevention](/09-Data_Leakage_Prevention/main), [Malware Scanners](/14-Malware_Scanners/main)
...
**Details:** [Authentication](/04-Authentication/main)
...
1. **[SSL Inspection](/05-SSL_Inspection/main)** — Enable HTTPS decryption
2. **[Authentication](/04-Authentication/main)** — Configure user authentication
3. **[Access Restriction](/08-Access_Restriction/main)** — Set up URL filtering and content policies
4. **[Troubleshooting](/23-Troubleshooting/main)** — Reference for common issues
